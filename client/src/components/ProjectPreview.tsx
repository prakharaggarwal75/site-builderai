...
const ProjectPreview = forwardRef<ProjectPreviewRef, ProjectPreviewProps>(function ProjectPreview({project, isGenerating, device = 'desktop', showEditorPanel = true}, ref) {
